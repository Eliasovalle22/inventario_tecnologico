...
SESSION_COOKIE_SECURE = False        # Se activa con ENABLE_SSL=True
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Sesiones en base de datos

# --- Cookie CSRF segura ---
CSRF_COOKIE_HTTPONLY = True
CSRF_COOKIE_SAMESITE = 'Lax'
CSRF_COOKIE_SECURE = False           # Se activa con ENABLE_SSL=True
...
ENABLE_SSL = str(config("ENABLE_SSL", default="False")).lower() in ["true", "1", "yes"]
if ENABLE_SSL:
